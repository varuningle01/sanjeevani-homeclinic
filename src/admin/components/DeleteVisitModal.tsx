      ...
      <div className="bg-white rounded-2xl shadow-xl max-w-md w-full">
        ...
        <div className="flex items-center justify-between p-6 border-b">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-gray-900">Delete Visit</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
            <p className="text-sm text-red-800">
              <strong>Warning:</strong> This action cannot be undone. All data associated with this visit, including attached reports, will be permanently deleted.
            </p>
          </div>
        </div>
