...
const AppointmentsPage = () => {
  ...
  const handleDateFilter = (
    type: "all" | "today" | "tomorrow" | "custom",
    customDate?: string
  ) => {
    setFilterType(type);
    ...
    <div className="space-y-6">
      ...
      <div>
        <h1 className="text-3xl font-bold text-gray-900">
          {labels.admin.appointments.title}
        </h1>
        <p className="text-gray-500 mt-1">
          {labels.admin.appointments.subtitle}
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="bg-white p-5 rounded-2xl shadow-sm border">
          <p className="text-xs text-gray-500 mb-1">
            {labels.admin.appointments.total}
          </p>
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border">
          <p className="text-xs text-gray-500 mb-1">
            {labels.admin.appointments.today}
          </p>
        ...
        <div className="bg-white p-5 rounded-2xl shadow-sm border">
          <p className="text-xs text-gray-500 mb-1">
            {labels.admin.appointments.upcoming}
          </p>
      ...
      <div className="bg-white rounded-2xl shadow-sm border p-4 sm:p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="font-semibold text-gray-900">
            {labels.admin.appointments.filter}
          </h2>
        </div>
        ...
        <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3">
          ...
          >
            {labels.admin.appointments.filterToday}
          </button>
          <button
          ...
          >
            {labels.admin.appointments.filterTomorrow}
          </button>
      ...
      {appointments.length === 0 ? (
        <div className="bg-white rounded-2xl shadow-sm border p-12 text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-700 mb-2">
            {labels.admin.appointments.notFound}
          </h3>
          <p className="text-gray-500">
            {selectedDate
              ? labels.admin.appointments.notFoundDate
              : labels.admin.appointments.notFoundAll}
          </p>
        </div>
      ) : (
        <div className="space-y-6">
